module.exports = {
    ...
    testRegex: "./server/test\/.*\.test\.js$", // Used to find test files, otherwise tries to run everything in __tests__ folder (non-existant for this project)
